...
const certifications = [
  {cert: 'AWS Certified Security – Specialty', link: 'https://www.credly.com/badges/27b03c0a-a46b-402e-b787-86f12ab7c75e'},
  ...
  return (
    <StyledContainer id="jobs" ref={revealContainer}>
      ...
      <StyledTabs>
        ...
        <br></br>
        Here's a list of my certifications and publications:
        <SkillsContainer>          
          {certifications.map((certifications) => <Skill key={certifications.cert}><a href={certifications.link}>{certifications.cert}</a></Skill>)}
        </SkillsContainer>
        <br></br>
        Check out the conferences I've presented at <a href={contalks}>here</a>.
    </StyledContainer>
  );
};
